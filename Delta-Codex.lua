...
mainFrame.Position = UDim2.new(0.5, -mainFrame.Size.X.Offset / 2, 0.5, -mainFrame.Size.Y.Offset / 2)  -- Centered horizontally and vertically as shown in the second image
...
-- Title Bar (Material You 3 style, darker, shorter, buttons match main menu grid)
local titleBarHeight = 32 -- add more background padding at the top of title bar
local btnW, btnH = 160, 32  -- match main menu button width/height
local gapX = 16
local offsetX = 22
